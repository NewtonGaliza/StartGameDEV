...
{
    [Header("Amounts")]
    [SerializeField] private int woodAmount; //total de madeira necessária pra construir uma casa
    [SerializeField] private Color startColor;
    [SerializeField] private Color endColor;
    [SerializeField] private float timeAmount; //tempo pra finalizar a casa
